...
$edit = mysqli_fetch_array(mysqli_query($koneksi,"SELECT * FROM tbl_ekstra_2511500012 WHERE id_ekstra_012='$id'"));
...
if(isset($_POST['tambah'])){
  ...
  $thn_ajaran_012     = $_POST['thn_ajaran_012'];
    ...
    $insert = mysqli_query($koneksi,"UPDATE tbl_ekstra_2511500012 SET nama_ekstra_012='$nama_ekstra_012', ket_012='$ket_012', semester_012='$semester_012', thn_ajaran_012='$thn_ajaran_012' WHERE id_ekstra_012='$id_ekstra_012' ");
    if ($insert) {
            ...
            <div class="card-body">
                <div class="card-body p-2">
                    <form method="POST" action="">
                        ...
                        <input type="text" name="id_ekstra_012" value="<?= $edit['id_ekstra_012']; ?>" placeholder="ID_EKSTRA_012" class="form-control" readonly>
                    </div>

                    <div class="form-group">
                        <label for="nama_ekstra_012">NAMA_EKSTRA_012</label> 
                        <input type="text" name="nama_ekstra_012" value="<?= $edit['nama_ekstra_012']; ?>" id="nama_ekstra_012" placeholder="NAMA_EKSTRA_012" class="form-control">
                    </div>

                     <div class="form-group">
                        <label for="ket_012">KET_012</label>
                        <input type="text" name="ket_012" value="<?= $edit['ket_012']; ?>" id="ket_012" placeholder="KET_012" class="form-control">
                    </div>
