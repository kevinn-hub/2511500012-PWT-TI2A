            ...
            <div class="card-body">
                <div class="card-body p-2">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nis" value="<?= $hasilkode; ?>" placeholder="NIS" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="int" name="id_kelas" id="id_kelas" placeholder="ID Kelas" class="form-control">
                    </div>
